...
UUID=7b031077-54a4-4a53-b696-439fb326c520   /mnt/paul-pc01-data_shared_ext4   ext4   nofail,x-systemd.automount,x-systemd.device-timeout=2   0   2
M5KJC
...
## sourcecode
sudo ln -s /mnt/paul-laptop01-data_shared_ext4/paul-disk01-data_shared_ext4/workspace-w001 /home/paul/
### data
